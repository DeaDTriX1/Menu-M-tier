...
function MenuMetier()
    ...
    while MenuMetier do
        Citizen.Wait(0)
                ...
                RageUI.ButtonWithStyle("~r~Mode suppression Props", "Supprimer des objets", { RightLabel = "XXX" }, true, function(Hovered, Active, Selected)
                end, PropsSupPN)
                ...
                RageUI.IsVisible(PropsPN, true, true, true, function()
                    ...
                    RageUI.ButtonWithStyle("Cone", nil, {}, true, function(Hovered, Active, Selected)
                        if Selected then
                            SpawnObj("prop_medstation_04")
                            ESX.ShowNotification('TU A FAIT SPAWN UN OBJECT !')
                        end
                    end)
